...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DriverLocationState);
}
...
$DriverLocationStateCopyWith(DriverLocationState _, $Res Function(DriverLocationState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  success,TResult Function( ApiErrorModel apiErrorModel)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  success,required TResult Function( ApiErrorModel apiErrorModel)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  success,TResult? Function( ApiErrorModel apiErrorModel)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class _Initial implements DriverLocationState {
  const _Initial();
...
@override
String toString() {
  return 'DriverLocationState.initial()';
}
...
class Loading implements DriverLocationState {
  const Loading();
...
@override
String toString() {
  return 'DriverLocationState.loading()';
}
...
class Success implements DriverLocationState {
...
@override
String toString() {
  return 'DriverLocationState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $DriverLocationStateCopyWith<$Res> {
...
class Error implements DriverLocationState {
...
@override
String toString() {
  return 'DriverLocationState.error(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $DriverLocationStateCopyWith<$Res> {
