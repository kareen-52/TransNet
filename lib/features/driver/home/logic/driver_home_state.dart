...
class DriverHomeState with _$DriverHomeState {
  ...
  const factory DriverHomeState.newOrderReceived(List<InstantOrderModel> orders) = NewOrderReceived;
  const factory DriverHomeState.orderRemoved(List<InstantOrderModel> orders) = OrderRemoved;
}