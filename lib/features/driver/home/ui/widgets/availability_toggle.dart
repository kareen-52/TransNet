...
class _AvailabilityToggleState extends State<AvailabilityToggle> {
  ...
  //   final newValue = !_localAvailable;
  ...
  //   if (success) {
  //     setState(() {
  //       _localAvailable = newValue;
  //       _isLoading = false;
  //     });
  //     locationCubit.toggleLocationTracking(newValue);
  //   } else {
  //     setState(() {
  //       _localAvailable = !newValue;
  //       _isLoading = false;
  ...
  //       SnackBar(
  //         content: const Text('حدث خطأ أثناء تغيير الحالة، حاول مرة أخرى'),
