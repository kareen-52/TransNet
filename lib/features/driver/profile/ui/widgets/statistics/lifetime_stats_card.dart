      ...
      child: Row(
        children: [
          Container(
            height: 54.w,
            width: 54.w,
            decoration: BoxDecoration(color: AppColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(16.r)),
            child: Icon(Icons.insights_rounded, color: AppColors.primary, size: 28.sp),
          ),
          horizontalSpace(16),
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurface.withOpacity(0.6), fontWeight: FontWeight.bold),
                ),
                verticalSpace(6),
                FittedBox(
