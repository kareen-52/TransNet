...
part of 'active_orders_state.dart';
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function()?  empty,TResult Function( List<ActiveOrderModel> orders)?  loaded,TResult Function( ApiErrorModel error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function()  empty,required TResult Function( List<ActiveOrderModel> orders)  loaded,required TResult Function( ApiErrorModel error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function()?  empty,TResult? Function( List<ActiveOrderModel> orders)?  loaded,TResult? Function( ApiErrorModel error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Empty() when empty != null:
...
class _Initial implements ActiveOrdersState {
  const _Initial();
...
@override
String toString() {
  return 'ActiveOrdersState.initial()';
}
...
class _Loading implements ActiveOrdersState {
  const _Loading();
...
class _Empty implements ActiveOrdersState {
  const _Empty();
...
@override
String toString() {
  return 'ActiveOrdersState.empty()';
}
...
class _Loaded implements ActiveOrdersState {
  const _Loaded(final  List<ActiveOrderModel> orders): _orders = orders;
  

 final  List<ActiveOrderModel> _orders;
 List<ActiveOrderModel> get orders {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ActiveOrdersStateCopyWith<$Res> {
...
class _Error implements ActiveOrdersState {
...
@override
String toString() {
  return 'ActiveOrdersState.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ActiveOrdersStateCopyWith<$Res> {
